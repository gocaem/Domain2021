...
Public Class EfawatercomReport
    ...
    Protected Sub OnPageIndexChanging(sender As Object, e As GridViewPageEventArgs)
        ...
        Catch ex As Exception
            If Not (TypeOf ex Is ThreadAbortException) Then
                File.AppendAllText(Server.MapPath("ErrorLog\ErrorLog.txt"), Environment.NewLine & "account\efawateercom:" + ex.Message + ex.StackTrace & " " + DateTime.Now)
            End If
    ...
    Protected Sub Printit_Click(sender As Object, e As EventArgs)
        ...
        ScriptManager.RegisterStartupScript(Page, Me.GetType(), "OpenWindow", "window.open('PrintedReport.aspx');", True)
    End Sub
End Class