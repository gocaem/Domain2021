<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admins/DNS/Site3.Master" CodeBehind="SendInvoice.aspx.vb" Inherits="Domain2021.SendInvoice" %>
                        ...
                        <div class="col-md-8 offset-md-2 col-xs-10 offset-xs-1  box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-10 m-0">
                                ...
                                <div class="card-body collapse in">
                                    <div class="card-block card-dashboard">
                                            ...
                                            <div class="form-body table" style="padding-left: 20px">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:RadioButtonList ID="ddl2" runat="server" RepeatDirection="Horizontal">
                                        ...
                                        <asp:UpdatePanel ID="up" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <br />
                                                <asp:GridView DataKeyNames="Domain_id"  EnableSortingAndPagingCallbacks="false" AllowPaging="True" GridLines="None" HorizontalAlign="Center" AutoGenerateColumns="False" ID="GridView2" CssClass="table table-responsive" runat="server"  OnPageIndexChanging="GridView2_PageIndexChanging"   >

                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="Select1"  runat="server" AutoPostBack="true" OnCheckedChanged="Select_CheckedChanged" CommandArgument='<%# Eval("Domain_id") %>' ></asp:CheckBox>
                                                        ...
                                                        <asp:TemplateField HeaderText="Billing Email"><ItemTemplate><asp:CheckBox runat="server" Text='<%# Eval("BillingEmail") %>' id="biling" HeaderText="Billing Email" DataField="BillingEmail" SortExpression="domain_name" Font-Bold="false"></asp:CheckBox></ItemTemplate></asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Admin Email"><ItemTemplate><asp:CheckBox runat="server" Text='<%# Eval("AdminEmail") %>'  id="admin" HeaderText="Admin Email" DataField="AdminEmail" SortExpression="domain_name" Font-Bold="false"></asp:CheckBox></ItemTemplate></asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Org Email"><ItemTemplate><asp:CheckBox runat="server" Text='<%# Eval("org_email") %>' id="org" HeaderText="Org Email" DataField="org_email" SortExpression="domain_name" Font-Bold="false"></asp:CheckBox></ItemTemplate></asp:TemplateField>
                                                        ...
                                                        <asp:BoundField HeaderText="Admin ID" DataField="Admin_id" SortExpression="end_date" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn"></asp:BoundField>
                                    ...
                                    <asp:SqlDataSource ID="selectSettings" runat="server" ConnectionString="<%$ ConnectionStrings:NewDNS %>"
                                        SelectCommand="send_financial_invoices" SelectCommandType="StoredProcedure">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="ddl2" Name="end_date" PropertyName="SelectedValue" Type="Int32" />
                                        </SelectParameters>
