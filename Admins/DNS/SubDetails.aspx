<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admins/DNS/Site3.Master" CodeBehind="SubDetails.aspx.vb" Inherits="Domain2021.SubDetails" ViewStateEncryptionMode="Always" %>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-6 col-md-6" id="Div1" runat="server">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Domain Name" ControlToValidate="txt_DOMAIN_NAME">*</asp:RequiredFieldValidator></td>
                                                                        ...
                                                                        <div class="col-lg-6 col-md-6" id="Div8" runat="server">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Second level domain" ControlToValidate="rbl_SECOND_DOMAIN">*</asp:RequiredFieldValidator></td>
                                                                                            ...
                                                                                            <table width="100%">
                                                                                                <tr>
                                                                                                    <td nowrap>
                                                                                                        ...
                                                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Primary nameserver" ControlToValidate="txt_PRIMARY_NAMESERVER">*</asp:RequiredFieldValidator></td>
                                                                                                    <td>
                                                    ...
                                                    <table id="Table2" cellspacing="1" cellpadding="1" style="width: 82%" class="table table-responsive">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:SqlDataSource runat="server" ID="SqlDataSource5" ConnectionString='<%$ ConnectionStrings:NewDNS %>' SelectCommand="select_class" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="NationalNo"
                                                                    ControlToValidate="NationalNo">*</asp:RequiredFieldValidator></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Description"
                                                                    ControlToValidate="Description">*</asp:RequiredFieldValidator></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:TextBox ID="txt_org_mobile" runat="server"></asp:TextBox></td>
                                                        </tr>


                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="Label7" runat="server" Font-Names="Calibri" Font-Size="Medium">E-Mail</asp:Label></td>
                                                            <td>
                                                                <asp:HyperLink ID="hl_mailto_org" runat="server" Font-Names="Calibri" Font-Size="Medium">MailTo</asp:HyperLink>
                                                                <asp:TextBox ID="txt_ORG_EMAIL" runat="server"></asp:TextBox></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="Label23" runat="server" Font-Names="Calibri" Visible="False" Font-Size="Medium">Authorized Name</asp:Label></td>
                                                            <td>
                                                                <asp:TextBox ID="txt_AUTHORIZED_NAME" runat="server" Visible="False"></asp:TextBox></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="Label24" runat="server" Font-Names="Calibri" Visible="True">Owner Name</asp:Label></td>
                                                            <td>
                                                                <asp:TextBox ID="txt_OWNER_NAME" runat="server" Visible="True"></asp:TextBox></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="Label35" runat="server" Font-Names="Calibri">Registration Date</asp:Label></td>
                                                            <td>
                                                                <asp:TextBox ID="txt_reg_date" runat="server"></asp:TextBox></td>
                                                        </tr>

                                                        <tr>
                                                            <td nowrap align="center" colspan="2">
                                                                <asp:RadioButtonList ID="rbl_IMMEDIATE_FUTURE" runat="server" Font-Names="Calibri" AutoPostBack="True"
                                                                    RepeatDirection="Horizontal" Font-Size="small">
                                                                    <asp:ListItem Value="1" Selected="True">Registering for immediate Usage</asp:ListItem>
                                                    ...
                                                    <table id="Table8" cellspacing="1" cellpadding="1" width="82%" class="table table-responsive">
                                                        ...
                                                        <tr>
                                                            <td align="center" colspan="2">
                                                                <asp:Button ID="Approve" runat="server" Font-Names="Calibri" Text="Approved"></asp:Button></td>
                                                        </tr>
                                                    </table>
                                                </asp:Panel>
                                                <p>
