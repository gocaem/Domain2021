...
Public Class SubDetails
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            Dim ocon_UploadedFiles As New Data.SqlClient.SqlConnection(ConfigurationManager.ConnectionStrings("NewDNS").ConnectionString)
        ...
        Catch ex As Exception
            If Not (TypeOf ex Is ThreadAbortException) Then
                File.AppendAllText(Server.MapPath("ErrorLog\ErrorLog.txt"), Environment.NewLine & "DNS\Statistics:" + ex.Message + ex.StackTrace & " " + DateTime.Now)
            End If
    ...
    Private Sub fill_db(ByVal Dom_id As Integer)
        Try
            ...
            Dim conn_det As New Data.SqlClient.SqlConnection(ConfigurationManager.ConnectionStrings("NewDNS").ConnectionString)
            ...
            While odr_det.Read
                ...
                If Not odr_det("DOMAIN_NAME") Is DBNull.Value Then
                    txt_DOMAIN_NAME.Text = Session("Sub") + "." + odr_det("DOMAIN_NAME")
                End If
                ...
                Else
                    ...
                    Dim CONN_det2 As New Data.SqlClient.SqlConnection(ConfigurationManager.ConnectionStrings("NewDNS").ConnectionString)
                    ...
                    ODR_det2.Close()
                    CONN_det2.Close()
                    Dim conn_server_data As New SqlConnection(ConfigurationManager.ConnectionStrings("NewDNS").ConnectionString)
    ...
    Private Function fill_E_Mail_LOG(ByVal dom_id As Integer) As Boolean
        ...
        Dim conn_log As New Data.SqlClient.SqlConnection(ConfigurationManager.ConnectionStrings("NewDNS").ConnectionString)
    ...
    Private Sub Approve_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Approve.Click
        ...
        Dim conn_Online As New Data.SqlClient.SqlConnection(ConfigurationManager.ConnectionStrings("NewDNS").ConnectionString)

        Try
            conn_Online.Open()
            comm_Online.Connection = conn_Online
            If rbl_onhold.SelectedIndex = 0 Then
                comm_Online.CommandText = "updateSub_on"
            Else
            ...
            comm_Online.Parameters.AddWithValue("did", Session("SubID"))
            ...
            comm_log.Parameters.AddWithValue("domain_id", Session("SubID"))
            If rbl_Approved.SelectedIndex = 1 Then
            ...
            comm_log.Parameters.AddWithValue("comment", "Sub Domain:" + Session("Sub") + "" + TXT_FIRST_COMMIT.Text)
    ...
    Private Function send_not_approv_EMail_update_data(ByVal domanes_id As Integer) As Boolean
        ...
        Dim conn_Notapprove As New Data.SqlClient.SqlConnection(ConfigurationManager.ConnectionStrings("NewDNS").ConnectionString)
        ...
        Try
            ...
            While red1_Notapprove.Read
                ...
                DOMAIN_NAME = Session("Sub") + "." + red1_Notapprove.Item("DOMAIN_NAME")
    ...
    Private Function send_not_approv_EMail(ByVal domanes_id As Integer) As Boolean
        ...
        Dim conn_mail As New Data.SqlClient.SqlConnection(ConfigurationManager.ConnectionStrings("NewDNS").ConnectionString)
        ...
        Try
            ...
            While red_log.Read
                ...
                Dim msg As String = "Sorry to inform you that your Sub Domain Name "
                msg &= Session("Sub") + "." + txt_DOMAIN_NAME.Text & Me.rbl_SECOND_DOMAIN.SelectedItem.ToString
    ...
    Private Function send_approv_EMail(ByVal domanes_id As Integer) As Boolean
        ...
        Dim conndomain_email As New Data.SqlClient.SqlConnection(ConfigurationManager.ConnectionStrings("NewDNS").ConnectionString)
        Dim reddomain_email As Data.SqlClient.SqlDataReader
        Dim comm_email2 As New Data.SqlClient.SqlCommand
        Dim conn_email2 As New Data.SqlClient.SqlConnection(ConfigurationManager.ConnectionStrings("NewDNS").ConnectionString)
        ...
        Try
            ...
            While reddomain_email.Read
                ...
                DOMAIN_NAME = Session("Sub") + "." + reddomain_email.Item("DOMAIN_NAME")
    ...
    Protected Sub SendEmailAr_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SendEmailAr.Click
        ...
        Else
            Dim conn_log As New SqlConnection(ConfigurationManager.ConnectionStrings("NewDNS").ConnectionString)
    ...
    Private Sub sendarabic_e_mail(ByVal em_id() As Integer, ByVal DOMAIN_NAME As String, ByVal SECOND_DOMAIN As String, ByVal GM__Commint As String, ByVal recipant_email As String, ByVal recipant_name As String)
        Dim conne_mail As New SqlConnection(ConfigurationManager.ConnectionStrings("NewDNS").ConnectionString)
        Dim comme_mail As New SqlCommand
        Dim red1e_mail As SqlDataReader
        Dim conn2e_mail As New SqlConnection(ConfigurationManager.ConnectionStrings("NewDNS").ConnectionString)
    ...
    Private Sub send_e_mail(ByVal em_id() As Integer, ByVal DOMAIN_NAME As String, ByVal SECOND_DOMAIN As String, ByVal GM__Commint As String, ByVal recipant_email As String, ByVal recipant_name As String)
        Dim conn_mail As New SqlConnection(ConfigurationManager.ConnectionStrings("NewDNS").ConnectionString)
        Dim comm_mail As New SqlCommand
        Dim red1_mail As SqlDataReader
        Dim conn_mail2 As New SqlConnection(ConfigurationManager.ConnectionStrings("NewDNS").ConnectionString)
    ...
    Private Function send_account_EMail(ByVal domanes_id As Integer) As Boolean
        Dim connemail As New SqlConnection(ConfigurationManager.ConnectionStrings("NewDNS").ConnectionString)
        Dim commemail As New SqlCommand
        Dim redemail1 As SqlDataReader
        Dim connemail2 As New SqlConnection(ConfigurationManager.ConnectionStrings("NewDNS").ConnectionString)
        Dim commemail2 As New SqlCommand
        Dim redemail2 As SqlDataReader
        Dim recipant_email, recipant_name, modee_m1, Subject, DOMAIN_NAME, SECOND_DOMAIN, OWNER_NAME, USER_PASSWORD, message_body, message_body1, message_body2, message_body3, message_body_4modee, message_body4 As String
        Dim LangFlag As String = ""
        Dim intLoopIndex As Integer
        message_body1 = "'"
        Try
        ...
        connemail.Close()
    End Function
    Sub GetPopupbillPrint(ByVal TargetPage As Page)

        Dim strScript As String = "<script language=javascript>window.open('Account/Receive_payable.aspx?Dom_id=" & Dom_id & "','cal','width=800,height=600,titlebar=no,scrollbars=yes,toolbar=no,resizeable=no,status=no')</script>"
        TargetPage.RegisterClientScriptBlock("GetPopupCustomer", strScript)
    ...
    Public Sub send_Invoice()
        ...
        Dim conn_Fees As New Data.SqlClient.SqlConnection(ConfigurationManager.ConnectionStrings("NewDNS").ConnectionString)
    ...
    Public Function text_msg() As String
        ...
        Dim conn_mail2 As New Data.SqlClient.SqlConnection(ConfigurationManager.ConnectionStrings("NewDNS").ConnectionString)
