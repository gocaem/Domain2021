<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admins/ViewOnly/SiteOnly.Master" CodeBehind="ReservedV.aspx.vb" Inherits="Domain2021.ReservedV" ViewStateEncryptionMode="Always" %>
                                            ...
                                            <div class="card-block card-dashboard">
                                                ...
                                                <div class="table-responsive">
                                                    <div class="modal-body" style="font-weight: bold; font-family: Calibri">
                                                        ...
                                                        <asp:GridView DataKeyNames="DomainName" Width="100%"  AllowPaging="true" AllowSorting="true" GridLines="None" HorizontalAlign="Center" AutoGenerateColumns="false" ID="GridView2" CssClass="table table-responsive" DataSourceID="selectSettings" runat="server">
