    ...
    Protected Sub GridView2_RowCommand(sender As Object, e As GridViewCommandEventArgs)
        ...
        Catch ex As Exception
            If Not (TypeOf ex Is ThreadAbortException) Then
                File.AppendAllText(Server.MapPath("ErrorLog\ErrorLog.txt"), Environment.NewLine & "viewonly\ServerManageV:" + ex.Message + ex.StackTrace & " " + DateTime.Now)
            End If
