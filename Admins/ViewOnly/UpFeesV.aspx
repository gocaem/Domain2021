<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admins/ViewOnly/SiteOnly.Master" CodeBehind="UpFeesV.aspx.vb" Inherits="Domain2021.UpFeesV" ViewStateEncryptionMode="Always" %>
                                            ...
                                            <div class="card-block card-dashboard">
                                                ...
                                                <div class="table-responsive">
                                                    <div class="modal-body" style="font-weight: bold; font-family: Calibri">
                                                       <asp:TextBox ID="JD" Visible="false" CssClass="form-control form-control-lg input-lg" runat="server" Width="50%" ></asp:TextBox>
                                                       <asp:TextBox ID="USD" Visible="false" CssClass="form-control form-control-lg input-lg" runat="server" Width="50%"></asp:TextBox>
                                                       <asp:DropDownList Visible="false" ID="ddl" CssClass="form-control form-control-lg input-lg" runat="server" Width="50%" DataSourceID="SqlDataSource1" DataTextField="SECOND_DOMAIN" DataValueField="SECOND_DOMAIN_ID"></asp:DropDownList><asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:NewDNS %>' SelectCommand="second_domain_data" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                                                       

                                                        <asp:Button ID="Button1" Visible="false" runat="server" Text="Add" CssClass=" form-group btn btn-cyan" Width="10%" OnClick="Button1_Click"></asp:Button><br />
                                                        ...
                                                        <asp:GridView DataKeyNames="ID" Width="100%" AllowPaging="true" AllowSorting="true" GridLines="None" HorizontalAlign="Center" AutoGenerateColumns="false" ID="GridView2" CssClass="table table-responsive" DataSourceID="SqlDataSource2" runat="server"  >
