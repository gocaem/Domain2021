...
Public Class Toastr
    ...
    Public Shared Sub ShowToast(Page As Page, Type As ToastType, Msg As String, Optional Title As String = "",
        ...
        ' Determine the type of the toast
        Select Case Type
        ...
        Dim script As String = "toastr.clear();" & vbCrLf &
                           "toastify('" & strType & "', '" & CleanStr(Msg) & "', '" & CleanStr(Title) & "', '" & strPosition & "', '" & ShowCloseButton.ToString.ToLower & "');"

        ' Register the JavaScript to run on the page
        ScriptManager.RegisterStartupScript(Page, Page.GetType(), "toastedMsg", script, True)
    End Sub
