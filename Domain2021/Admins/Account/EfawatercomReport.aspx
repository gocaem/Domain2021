<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admins/Account/Site2.Master" CodeBehind="EfawatercomReport.aspx.vb" Inherits="Domain2021.EfawatercomReport" ViewStateEncryptionMode="Always" %>
                                                    ...
                                                    <table id="table4" class="table">
                                                        ...
                                                        <tr>
                                                            <td class="auto-style10">
                                                                ...
                                                                <p style="width: 683px">
                                                                    From Date:
                                                                  <%--  <input type="text" id="RadDatePicker1" runat="server">--%>
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" '<%# ReusableCode.Decrypt(ConfigurationManager.ConnectionStrings("NEWDNS").ConnectionString) %>' SelectCommand="efawatercomInvoicesdet" SelectCommandType="StoredProcedure">
                                                                                        <SelectParameters>
