<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admins/DNS/Site3.Master" CodeBehind="Details.aspx.vb" Inherits="Domain2021.Details" ViewStateEncryptionMode="Always" %>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <p>
                                                <ul class="nav nav-tabs" role="tablist" id="tablist" runat="server" visible="true" style="height: auto">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab" href="#tabs-8" role="tab">Request Papers</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab" href="#tabs-7" role="tab">Approval</a>
                                                    </li>
                                                </ul>
                                                ...
                                                <div class="tab-content" id="ttab1" style="width: 70%" runat="server" visible="true">
                                                    <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6 col-md-6" id="Div1" runat="server">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <asp:TextBox ID="txt_DOMAIN_NAME" runat="server" Font-Names="Calibri" Enabled="false" CssClass="form form-control"></asp:TextBox>
                                                                ...
                                                                <div class="col-lg-6 col-md-6" id="Div8" runat="server">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <asp:DropDownList ID="rbl_SECOND_DOMAIN" CssClass="form form-control" runat="server" DataValueField="SECOND_DOMAIN_ID" DataTextField="SECOND_DOMAIN" DataSourceID="SqlDataSource1">
                                                                        </asp:DropDownList>
                                                        ...
                                                        <asp:Panel ID="Panel_newNameServer" runat="server">
                                                            <div class="row">
                                                                <div class="col-lg-12 col-md-12" id="Div7" runat="server">
                                                                    <div class="form-group">
                                                                        <label id="Label16" runat="server">
                                                                            ...
                                                                            <table width="100%">
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txt_PRIMARY_NAMESERVER" runat="server" CssClass="form form-control"></asp:TextBox>
                                                                                    </td>
                                                                                    <td nowrap>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txt_PRIMARY_IP_ADDRESS" runat="server" CssClass="form form-control"></asp:TextBox>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txt_SECONDARY_NAMESERVER" runat="server" CssClass="form form-control"></asp:TextBox></td>
                                                                                    <td nowrap>
                                                                                        <asp:Label ID="Label13" runat="server" Font-Names="Calibri" Font-Bold="False" Font-Size="Medium">IP address: &nbsp;</asp:Label></td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txt_SECONDARY_IP_ADDRESS" runat="server" CssClass="form form-control"></asp:TextBox></td>
                                                                                </tr>
                                                                            </table>
                                                                        </label>
                                                                    </div>
                                                    ...
                                                    <div class="tab-pane" id="tabs-6" role="tabpanel">
                                                        <asp:Panel ID="DomainMainDetailsP" runat="server">
                                                            <table id="Table2" cellspacing="1" cellpadding="1" style="width: 100%" class="table table-responsive">

                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label1" runat="server" Font-Names="Calibri" Font-Size="Medium"> Entity Name</asp:Label></td>
                                                                    <td>
                                                                        <asp:TextBox ID="TXT_ORG_NAME" runat="server" CssClass="form form-control"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:DropDownList ID="classify" CssClass="form form-control" runat="server" DataSourceID="SqlDataSource5" DataTextField="ClassificationNameEn" DataValueField="ClassificationID"></asp:DropDownList>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txt_OWNER_NAME" runat="server" Visible="True" CssClass="form form-control"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="NationalNo" runat="server" CssClass="form form-control"></asp:TextBox>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label5" runat="server" Font-Names="Calibri" Font-Size="Medium"> Description</asp:Label></td>
                                                                    <td>
                                                                        <asp:TextBox ID="Description" runat="server" CssClass="form form-control"></asp:TextBox>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txt_org_mobile" runat="server" CssClass="form form-control"></asp:TextBox>
                                                                    </td>
                                                                    <tr>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <asp:TextBox ID="txt_ORG_EMAIL" runat="server" CssClass="form form-control"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                <tr>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txt_AUTHORIZED_NAME" runat="server" Visible="False" CssClass="form form-control"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txt_reg_date" runat="server" CssClass="form form-control"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                    ...
                                                    <div class="tab-pane" id="tabs-5" role="tabpanel">
                                                        <asp:Panel ID="User_Panel" runat="server">
                                                            <table id="Table6" cellspacing="1" cellpadding="1" width="100%" class="table table-responsive">

                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label25" runat="server" Font-Names="Calibri" Font-Size="Medium">User Name</asp:Label></td>
                                                                    <td>
                                                                        <asp:TextBox ID="txt_COMPANY_USER_NAME" runat="server" CssClass="form form-control"></asp:TextBox></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label14" runat="server" Font-Names="Calibri" Font-Size="Medium">Administrative Contact</asp:Label></td>
                                                                    <td>
                                                                        <asp:TextBox ID="txt_ADMIN_CONTACT" runat="server" CssClass="form form-control"></asp:TextBox></td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    <td>Mobile</td>
                                                                    <td>
                                                                        <asp:TextBox ID="txt_admin_mobile" runat="server" CssClass="form form-control"></asp:TextBox></td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:TextBox ID="txt_EMAIL" runat="server" CssClass="form form-control"></asp:TextBox></td>
                                                                </tr>
                                                            </table>
                                                        </asp:Panel>
                                                    </div>
                                                    ...
                                                    <div class="tab-pane" id="tabs-3" role="tabpanel">
                                                        <asp:Panel ID="Tech_panel" runat="server">
                                                            <table id="Table3" cellspacing="1" cellpadding="1" width="100%" class="table table-responsive">

                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label34" runat="server" Font-Names="Calibri" Font-Size="Medium">Tech Contact</asp:Label></td>
                                                                    <td>
                                                                        <asp:TextBox ID="txt_TECH_CONTACT" runat="server" CssClass="form form-control"></asp:TextBox></td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:TextBox ID="txt_tech_mobile" runat="server" CssClass="form form-control"></asp:TextBox></td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:TextBox ID="txt_tech_EMAIL" runat="server" CssClass="form form-control"></asp:TextBox></td>
                                                                </tr>
                                                            </table>
                                                        </asp:Panel>
                                                    </div>
                                                    ...
                                                    <div class="tab-pane" id="tabs-4" role="tabpanel">
                                                        <asp:Panel ID="Bill_Panel" runat="server">
                                                            <table id="Table5" cellspacing="1" cellpadding="1" width="100%" class="table table-responsive">

                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label36" runat="server" Font-Names="Calibri" Font-Size="Medium">Billing Contact</asp:Label></td>
                                                                    <td>
                                                                        <asp:TextBox ID="txt_BILLING_CONTACT" runat="server" CssClass="form form-control"></asp:TextBox>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:TextBox ID="txt_billing_mobile" runat="server" CssClass="form form-control"></asp:TextBox></td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:TextBox ID="txt_billing_EMAIL" runat="server" CssClass="form form-control"></asp:TextBox></td>
                                                                </tr>
                                                            </table>
                                                        </asp:Panel>
                                                    </div>
                                                    ...
                                                    <div class="tab-pane" id="tabs-7" role="tabpanel">
                                                        ...
                                                        <asp:Panel ID="Panel11" runat="server">
                                                            <table id="Table8" cellspacing="1" cellpadding="1" width="100%" class="table table-responsive" style="border-collapse: collapse; background-color: #e4e7e9">

                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label27" runat="server" Font-Names="Calibri" Font-Size="Medium">Approve Or Not</asp:Label></td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td align="center" colspan="2">
                                                                        <asp:Button ID="Approve" CssClass="btn btn-black" runat="server" Font-Names="Calibri" Text="Take an action"></asp:Button></td>
                                                                </tr>
                                                            </table>
                                                        </asp:Panel>
                                                    ...
                                                    <div class="tab-pane" id="tabs-8" role="tabpanel">
                                                        <div class="tab-content" id="Div27" style="width: 100%" runat="server" visible="true">
                                                            <asp:Panel ID="Panel_send_email" runat="server" Visible="true">
                                
                                                                            <h4 ID="Emailsc" runat="server" Font-Names="Calibri" >E-Mail Category</h4> 
                                                                      
                                                                            <asp:Label ID="SelectedEmaillbl" ForeColor="red" runat="server" Font-Names="Calibri"></asp:Label>
                                                                            <asp:GridView ID="GridView1" OnRowCommand="GridView1_RowCommand" CssClass="table table-responsive" Width="100%" runat="server" DataSourceID="SqlDataSource3" AutoGenerateColumns="true" DataKeyNames="id">
                                                                                <Columns>
                                                                                    <asp:TemplateField>
                                                                                        <ItemTemplate>
                                                                                           ...
                                                                                           <asp:TemplateField>
                                                                                        <ItemTemplate>
                                                                                            <asp:LinkButton  ID="delete" runat="server" CommandName="delete1" CommandArgument='<%# Eval("id") %>'  ><li class="fa fa-delete-left" style="color:red"></li></asp:LinkButton>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                          <asp:BoundField DataField="id"  HeaderText="id" ReadOnly="True" InsertVisible="False" SortExpression="id" HeaderStyle-CssClass="hideGridColumn" ItemStyle-CssClass="hideGridColumn"></asp:BoundField>
                                                      
                                                                                </Columns>
                                                                            </asp:GridView>
                                                                            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:NewDNS %>"
                                                                                SelectCommand="selectemailpapers" SelectCommandType="StoredProcedure"></asp:SqlDataSource>

                                                                   
                                                                            <asp:Button ID="SendEmailPaperAr" runat="server" Font-Names="Calibri" Text="Send E-Mail Arabic" OnClick="SendEmailPaperar_Click" ValidationGroup="aa" CssClass="btn btn-success"></asp:Button>
                                                                            <asp:Button ID="SendEmailPaperEn" runat="server" Font-Names="Calibri" Text="Send E-Mail English" OnClick="SendEmailPaperen_Click" ValidationGroup="aa" CssClass="btn btn-info"></asp:Button><br /><br />
                                                               <div style="border-style:solid;border-collapse:collapse"><h4>Add Email&nbsp;  </h4>  Email Arabic Text:<br />  <asp:TextBox ID="emailartext" runat="server" CssClass="form form-control"  Width="300px"></asp:TextBox><asp:RequiredFieldValidator ID="emailar" runat="server" ErrorMessage="Required" ValidationGroup="bb"  ForeColor="red" ControlToValidate="emailartext"></asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="regemailar" ControlToValidate="emailartext" ValidationGroup="bb" runat="server" ErrorMessage="only arabic letters" ValidationExpression="^[\u0600-\u06FF\s.،]+$" ForeColor="red"></asp:RegularExpressionValidator><br />Email English Text:<br />  <asp:TextBox ID="emailentext" runat="server" CssClass="form form-control" Width="300px"></asp:TextBox><asp:RequiredFieldValidator ID="emailen" runat="server" ErrorMessage="Required" ForeColor="red" ControlToValidate="emailentext" ValidationGroup="bb"></asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="regenexp" ControlToValidate="emailentext" ValidationGroup="bb" runat="server" ErrorMessage="only english letters" ValidationExpression="^[A-Za-z'.,\s]+$" ForeColor="red"></asp:RegularExpressionValidator><br /><asp:LinkButton ID="add" runat="server" Width="300px" CssClass="btn btn-warning" OnClick="add_Click" ValidationGroup="bb"><li class="fa fa-plus"></li></asp:LinkButton><br /> <br /></div>
                                                            </asp:Panel>
                                                            <!-- /.modal-content -->
                                                        </div>
