<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admins/DNS/Site3.Master" CodeBehind="DomainManage.aspx.vb" Inherits="Domain2021.DomainManage" ViewStateEncryptionMode="Always" %>
    ...
    <asp:UpdatePanel ID="up" runat="server">
        <ContentTemplate>
            <div>
                <div class="app-content content container-fluid">
                                                ...
                                                <div class="table-responsive"> <asp:Label ID="lbl_error" runat="server" ForeColor="red"></asp:Label>
                                                    <div class="modal-body" style="font-weight: bold; font-family: Calibri">
                                                        ...
                                                        <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal">
                                                            ...
                                                            <asp:ListItem Value="1">&nbsp;StartWith&nbsp;</asp:ListItem>
                                                            <asp:ListItem Value="2">&nbsp;EndWith&nbsp;</asp:ListItem>
                                                        </asp:RadioButtonList>
                                                        ...
                                                        <asp:SqlDataSource runat="server" ID="selectSettings" ConnectionString='<%# ReusableCode.Decrypt(ConfigurationManager.ConnectionStrings("NEWDNS").ConnectionString) %>' SelectCommand="Likesearch" SelectCommandType="StoredProcedure">
                                                            <SelectParameters>
                                                        ...
                                                        <div class="tab-pane active" id="tabs-1" role="tabpanel" width="70%">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4 col-md-4" id="Div2" runat="server">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <asp:Label CssClass="form-control" ID="Domain_nameLabel" runat="server"   ></asp:Label>
                                                                ...
                                                                <div class="col-lg-4 col-md-4" id="Div4" runat="server">
                                                                    ...
                                                                    <asp:DropDownList Font-Bold="true" enabled="false"  CssClass="form-control" ID="SecondDomain" runat="server" DataSourceID="SqlDataSource1" DataTextField="SECOND_DOMAIN" DataValueField="SECOND_DOMAIN_ID">
                                                                    </asp:DropDownList>
                                                            ...
                                                            <div class="row">
                                                                  <div class="col-lg-4 col-md-4" id="Div1" runat="server">
                                                                   ...
                                                                   <div class="col-lg-4 col-md-4" id="Div31" runat="server">
                                                                  <div class="form-group">
                                                                ...
                                                                <div class="col-lg-4 col-md-4" id="Div17" runat="server">
                                                                    <div class="form-group">
                                                                        <label id="Label33" runat="server">
                                                                            <asp:Label ID="TechMobileLabel" Text="Phone" runat="server" Font-Bold="True"></asp:Label></label>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label id="Label15" runat="server">
                                                                                <asp:Label ID="Label6" Text="Mobile Number" runat="server" Font-Bold="True"></asp:Label></label>
                                                                                 <asp:Button ID="SendSMS" CssClass="btn btn-danger" runat="server" Text="Send Username SMS" OnClick="SendSMS_Click" />
                                                                            ...
                                                                            <asp:Label ID="Sent" runat="server"  ForeColor="Red"></asp:Label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                
                                                                <div class="row">
                                                                    <div class="col-lg-12 col-md-12" id="Div15" runat="server">
                                                                        <div class="form-group">
                   ...
                   <asp:Button ID="SendEmailAR" CssClass="btn btn-success" runat="server" Text="Send Username EmailAR" OnClick="SendEmail_Click" />
                                                                           <asp:Button ID="SendEmailEn" CssClass="btn btn-blue-grey" runat="server" Text="Send Username EmailEn" OnClick="SendEmailEn_Click"/>
                                                                  ...
                                                                  <div class="row">
                                                                    <div class="col-lg-6 col-md-6" id="Div26" runat="server">
                                                                      ...
                                                                      <div class="col-lg-6 col-md-6" id="Div27" runat="server">
        ...
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="Button1" />
               <asp:PostBackTrigger ControlID="SendSMS" />
               <asp:PostBackTrigger ControlID="SendEmailEn" />
               <asp:PostBackTrigger ControlID="SendEmailAR" />
