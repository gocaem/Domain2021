<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PrintInvoice.aspx.vb" Inherits="Domain2021.PrintInvoice" ViewStateEncryptionMode="Always" %>
...
<head runat="server">
    ...
    <link href="../font-awesome-4.7.0/css/font-awesome.min.css" media="all" rel="stylesheet" type="text/css">
    ...
    <link href='http://fonts.googleapis.com/css?family=Lato:300,400|Dancing+Script' media="all" rel='stylesheet' type='text/css' />
    <link rel="stylesheet" href="../css/bootstrap.min.css" media="all">
