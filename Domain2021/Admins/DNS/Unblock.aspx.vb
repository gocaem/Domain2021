...
Public Class Unblock
        ...
        If Me.IsPostBack = False Then
            ...
            Catch ex As Exception
                If Not (TypeOf ex Is ThreadAbortException) Then
                    File.AppendAllText(Server.MapPath("ErrorLog\ErrorLog.txt"), Environment.NewLine & "DNS\unlock:" + ex.Message + ex.StackTrace & " " + DateTime.Now)
                End If
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Catch ex As Exception
            If Not (TypeOf ex Is ThreadAbortException) Then
                File.AppendAllText(Server.MapPath("ErrorLog\ErrorLog.txt"), Environment.NewLine & "DNS\unblock:" + ex.Message + ex.StackTrace & " " + DateTime.Now)
            End If
