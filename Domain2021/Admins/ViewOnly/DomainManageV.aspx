<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admins/ViewOnly/SiteOnly.Master" CodeBehind="DomainManageV.aspx.vb" Inherits="Domain2021.DomainManageV" ViewStateEncryptionMode="Always" %>
                                                                    ...
                                                                    <asp:DataList ID="UploadedFiles" runat="server" Font-Names="Calibri" Font-Size="Medium">
                                                                        <ItemTemplate>
                                                                            <table id="Table7" cellspacing="1" cellpadding="1" width="100%" border="0">
                                                                                <tr>
                                                                                    <td>
                                                                                        <asp:HyperLink ID="HyperLink1" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.

post_name", "{0}") %>' NavigateUrl='<%# DataBinder.Eval(Container, "DataItem.file_post_name", "../../
...
/{0}") %>' Target="_blank">
        ...
        <Triggers>
           ...
           <asp:PostBackTrigger ControlID="Domain_name"  />
