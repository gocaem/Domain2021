    ...
    Protected Sub OnPageIndexChanging(sender As Object, e As GridViewPageEventArgs)
        ...
        Catch ex As Exception
            If Not (TypeOf ex Is ThreadAbortException) Then
                File.AppendAllText(Server.MapPath("ErrorLog\ErrorLog.txt"), Environment.NewLine & "viewonly\EfawateerComRepV:" + ex.Message + ex.StackTrace & " " + DateTime.Now)
            End If
