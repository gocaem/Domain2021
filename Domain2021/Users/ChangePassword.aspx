<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Users/MasterPage_Ar.Master" CodeBehind="ChangePassword.aspx.vb" Inherits="Domain2021.ChangePassword" ViewStateEncryptionMode="Always" %>
...
<asp:Label type="label" ForeColor="red" Font-Bold="true"  id="InputUsernameL" runat="server"  required  ></asp:Label>
</div></div>
</div>
        <div class="row"><div class="col-lg-8 col-md-8" id="Div4" runat="server">
<label for="InputPassword" id="Label4" runat="server"><asp:Label ID="OldPasswordlbl" runat="server" Font-Bold="True"></asp:Label></label>
<asp:TextBox  runat="server" AutoCompleteType="None" type="password" id="OldPassword" TextMode="Password" CssClass="form-control first" placeholder="Old Password" autofocus></asp:TextBox>
    

          
    	 		
    </div><div class="col-lg-4 col-md-4">  </div> <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ForeColor="Red" runat="server" ControlToValidate="OldPassword"></asp:RequiredFieldValidator></div>
...
<div id="jak_pstrength" class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%;"></div>
  ...
  <asp:RegularExpressionValidator ControlToValidate="password"  ID="RegularExpressionValidator1" ForeColor="Red" runat="server" ErrorMessage="RegularExpressionValidator" ValidationExpression="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{10,}$"></asp:RegularExpressionValidator>
...
<asp:TextBox  type="password" cssclass="form-control" id="TextBox1" runat="server" TextMode="Password" placeholder="Password" required ></asp:TextBox>
 <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ForeColor="Red" ControlToValidate="TextBox1"></asp:RequiredFieldValidator></div>  <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="password" ControlToCompare="TextBox1" ></asp:CompareValidator>
</div>
...
<div class="row"><div class="col-lg-8 col-md-8" id="Div3" runat="server">
    <asp:Button ID="Button1" runat="server"   type="submit" cssclass="btn btn-info"  />
    </div></div><br /></div>
