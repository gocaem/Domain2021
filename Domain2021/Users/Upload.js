...
function FileSelectHandler(e) {
	...
	sFolder=form1.getElementById('hdnFolder').value;
	if (sFolder=="") sFolder = "DOC";
	
	var sHtml = "<table id='tbClient' class='table table-responsive' ><tr><th>File name</th><th>Size</th><th>Date Modified</th>"
