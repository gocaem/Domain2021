    ...
    Private Sub welcome_fun()
        ...
        Catch ex As Exception
            If Not (TypeOf ex Is ThreadAbortException) Then
                File.AppendAllText(Server.MapPath("ErrorLog\ErrorLog.txt"), Environment.NewLine & "Users\MasterPage_Ar:" + ex.Message + ex.StackTrace & " " + DateTime.Now)
            End If
        End Try
    End Sub

    Private Sub MasterPage_Ar_PreRender(sender As Object, e As EventArgs) Handles Me.PreRender
        Session("lang") = "ar"
    End Sub

    Private Sub MasterPage_Ar_Init(sender As Object, e As EventArgs) Handles Me.Init
        Session("lang") = "ar"
    End Sub
End Class