<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="popupU.aspx.vb" Inherits="Domain2021.popupU" ValidateRequest="false" %>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" id="btnc" runat="server" class="btn btn-default pull-left" data-dismiss="modal" onclick="location.href='mydomains.aspx'">Close</button>
